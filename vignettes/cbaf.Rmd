---
title: "cbaf: Automated Functions for cBioPortal"
...
- __angleColumnLabels__ a number that determines the angle with which the studies/study subgroups names are shown on heatmaps. The default value is 45 degree.
...
```{r, eval = FALSE}
heatmapOutput("test", shortenStudyNames = TRUE, heatmapMargines = c(13,5), heatmapColor = "RdGr", genesToDrop = c("PVT1", "SNHG6"), RowCex = 1, ColCex = 1, reverseColor = FALSE)
```
...
processOneStudy(genes, "test", "Breast Invasive Carcinoma (TCGA, Cell 2015)", "RNA-Seq", desiredCaseList = c(2,3,4,5), calculate = c("frequencyPercentage",  "frequencyRatio"), RowCex = 1, ColCex = 1)
```
