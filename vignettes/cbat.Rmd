...
This function scans all the cancer studies to examine presence of _RNA-seq_, _microRNA-seq_, _microarray_ and _methylation_ data for every study. It requires a name  as a necessary argument.
```
    availableData("name")
```    
