...
#'
#' @param obtainedDataType a character string that specifies the type of input data produced by the previous function. Two options are availabe:
#' 'single study' for obtainOneStudy() and 'multiple studies' for obtainMultipleStudies(). The function uses obtainedDataType and submissionName
...
#'
#'
#' @return A new section in the BiocFileCache object that was created by one of the obtainOneStudy() or obtainMultipleStudies() functions. It contains
